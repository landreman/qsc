...
TEST_CASE("curvature and torsion: stellarator-symmetric case") {
  ...
  double curvature_fortran[] = {1.74354628565018, 1.61776632275718, 1.5167042487094,
  ...
  double torsion_fortran[] = {0.257226801231061, -0.131225053326418, -1.12989287766591,
  ...
  double varphi_fortran[] = {0, 0.0909479184372571, 0.181828299105257,
...
TEST_CASE("curvature and torsion: non-stellarator-symmetric case") {
  ...
  double curvature_fortran[] = {2.10743037699653, 2.33190181686696, 1.83273654023051,
  ...
  double torsion_fortran[] = {-0.167822738386845, -0.0785778346620885, -1.02205137493593,
  ...
  double varphi_fortran[] = {0, 0.084185130335249, 0.160931495903817,
