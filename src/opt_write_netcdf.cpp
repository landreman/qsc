...
void Opt::write_netcdf() {
  ...
  nc.put("weight_arclength_variance", weight_arclength_variance, "Weight for the arclength_variance term in the objective function for optimization", "dimensionless");
  ...
  nc.put(n_iter_dim, "iter_arclength_variance_term", iter_arclength_variance_term, "arclength_variance term in the objective function at each iteration", "dimensionless");
